...
interface ImportSoalDialogProps {
  ujianId: string
  ujianStatus: string
  onSuccess?: () => void
}

export function ImportSoalDialog({ ujianId, ujianStatus, onSuccess }: ImportSoalDialogProps) {
      ...
      <DialogTrigger
        render={
          <Button
            ...
            className="gap-2"
            disabled={isDisabled}
            title={isDisabled ? "Nonaktifkan ujian terlebih dahulu untuk import" : "Import dari Excel"}
          >
        ...
        <div className="space-y-4">
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <ul className="text-sm text-blue-700 space-y-1 list-disc list-inside">
              ...
              <li><strong>Gambar_URL</strong> - URL gambar (opsional)</li>
            </ul>
            <Button
              type="button"
              variant="outline"
